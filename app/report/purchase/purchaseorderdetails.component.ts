...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/purchase/purchaseorderdetails.component.html',
...
//    public minDate: Date = void 0;
    ...
    private activeMenu: string = "purchaseorderdetails";
    ...
    searchPurchaseOrderDetails(event: Event){
        
    }
    printPurchaseOrderDetails(event: Event){

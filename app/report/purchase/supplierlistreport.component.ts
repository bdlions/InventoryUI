...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/purchase/supplierlistreport.component.html',
...
export class SupplierListReport {
    ...
    private activeMenu: string = "supplierlistreport";
    ...
    searchSupplierListReport(event: Event){
        
    }
    printSupplierListReport(event: Event){

...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/purchase/supplierpaymentsummary.component.html',
...
//    public minDate: Date = void 0;
    ...
    searchSupplierPaymentSummary(event: Event){
        
    }
    printSupplierPaymentSummary(event: Event){

...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/sales/customerlistreport.component.html',
    providers: [WebAPIService]
})

export class CustomerListReport {
    private webAPIService: WebAPIService;
    private subscribe: Subscription;
    //private searchDTOCustomer: DTOCustomer;
    private showNavBar: boolean = false;
    private activeMenu: string = "customerlistreport";
    ...
    searchCustomerListReport(event: Event){
        
    }
    printCustomerListReport(event: Event){

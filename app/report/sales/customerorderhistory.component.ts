...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/sales/customerorderhistory.component.html',
...
export class CustomerOrderHistory {
    ...
    private activeMenu: string = "customerorderhistory";
    ...
    searchCustomerOrderHistory(event: Event){
        
    }
    printCustomerOrderHistory(event: Event){

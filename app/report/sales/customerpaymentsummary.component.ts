...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/sales/customerpaymentsummary.component.html',
...
//    public minDate: Date = void 0;
    ...
    private activeMenu: string = "customerpaymentsummary";
    ...
    searchCustomerPaymentSummary(event: Event) {

    }
    printCustomerPaymentSummary(event: Event) {

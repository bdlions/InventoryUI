...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/sales/salesorderprofit.component.html',
    providers: [WebAPIService]
})

export class SalesOrderProfit {
...
//    public minDate: Date = void 0;
    ...
    private activeMenu: string = "salesorderprofit";
    ...
    searchSalesOrderProfit(event: Event) {

    }
    printSalesOrderProfit(event: Event) {

...
@Component({
    selector: 'app',
    templateUrl: 'app/html/report/sales/salesorderprofitsummary.component.html',
    providers: [WebAPIService, DatePipe]
})

export class SalesOrderProfitSummary {
    ...
    public showSaleOrder(event: Event, orderNo: string) {
        ...
        this.navigationManager.setActiveMenu("saleorderprofit");
        this.router.navigate(["saleorderprofit", {orderNo: orderNo}]);
    }
